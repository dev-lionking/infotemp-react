          ...
          <div className="card mb-3 mx-auto bg-dark text-light">
            <div className="row g-0">
              <div className="col-md-4">
                ...
                <img
                  src="https://images.pexels.com/photos/3849167/pexels-photo-3849167.jpeg?cs=srgb&dl=pexels-kehn-hermano-3849167.jpg&fm=jpg&_gl=1*ugztqt*_ga*MjA4ODA0NjQ1Ni4xNjY3MzI5Njgw*_ga_8JE65Q40S6*MTY2NzQxMjc2Mi4yLjAuMTY2NzQxMjc2Mi4wLjAuMA.."
              ...
              <div className="col-md-8">
                <div className="card-body text-start-mt-2">
                  <h5 className="card-text">
                    Temperatura máxima:{" "}
                    {(weather.main.temp_max - 273.15).toFixed(1)}º C
                  </h5>
                  <h5 className="card-text">
                    Temperatura minima:{" "}
                    {(weather.main.temp_min - 273.15).toFixed(1)}º C
                  </h5>
                  <h5 className="card-text">
                    Sensación térmica:{" "}
                    {(weather.main.feels_like - 273.15).toFixed(1)}º C
                  </h5>
                  <h5 className="card-text">
                ...
                <div className="row mt-4">
                  <div className="col">
                    ...
                    <p className="temp">
                      {(forecast.list[1].main.temp - 273.15).toFixed(1)}º c
                    </p>
                  </div>
                  <div className="col">
                    ...
                    <p className="temp">
                      {(forecast.list[2].main.temp - 273.15).toFixed(1)}º c
                    </p>
                  </div>
                  <div className="col">
                    <p>{forecastDate3}hs</p>
                    ...
                    <p className="temp">
                      {(forecast.list[3].main.temp - 273.15).toFixed(1)}º c
                    </p>
                  </div>
                </div>
              </div>
